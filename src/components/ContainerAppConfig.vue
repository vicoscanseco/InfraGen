  ...
  <v-card class="mb-4">
    ...
    <v-card-text>
      <v-row dense class="mt-3">
        <v-col cols="12" md="6">
          <v-tooltip text="Define el nombre base de tu Container App. Se combinará automáticamente con el entorno (dev, test, qa) para crear el nombre final único en Azure. En producción no se incluye el environment.">
